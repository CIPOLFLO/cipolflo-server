...
```json
{
  ...
  "filasConError": 2,
  "detalleErrores": [
    { "numeroFila": 4, "codigoError": "CEDULA_DUPLICADA", "motivo": "Ya existe un socio con la cédula 12345678" },
...
- Además del `Content-Type`, se verifican los *magic bytes* del archivo: un archivo con
